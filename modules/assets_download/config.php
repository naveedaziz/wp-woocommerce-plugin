	...
	array(
		'assets_download' => array(
			...
			'in_dashboard' => array(
				...
				'url'	=> admin_url("admin.php?page=AmazonWooCommerce_assets_download")
			),
			'help' => array(
				'type' => 'remote',
			...
			'load_in' => array(
				'backend' => array(
					'admin.php?page=AmazonWooCommerce_assets_download',
					'admin.php?page=AmazonWooCommerce_asin_grabber',
					'admin-ajax.php'
				),
				'frontend' => false
			),
