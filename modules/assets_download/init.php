...
if (class_exists('AmazonWooCommerceAssetDownload') != true) {
    class AmazonWooCommerceAssetDownload
    {
        /*
        ...
        */
        public function __construct()
        {
			...
			$this->settings = $AmazonWooCommerce->getAllSettings('array', 'amazon');
  
			if (is_admin()) {
	            add_action('admin_menu', array( &$this, 'adminMenu' ));
			}
			
			add_action('wp_ajax_AmazonWooCommerce_download_asset', array( &$this, 'ajax_download_asset' ));
			add_action('wp_ajax_AmazonWooCommerceDeleteAssetsProducts', array( &$this, 'delete_products_asset' ));
			$this->__test_assets();
        }
	    ...
	    * Singleton pattern
	    *
	    * @return AmazonWooCommerceAssetDownload Singleton instance
	    */
		...
		<div id="AmazonWooCommerce-wrapper" class="fluid wrapper-AmazonWooCommerce AmazonWooCommerce-asset-download">
			...
			<div id="AmazonWooCommerce-content">
				...
				<h1 class="AmazonWooCommerce-section-headline">
					...
					<span class="AmazonWooCommerce-section-info"><?php echo $this->module['assets_download']['description'];?></span>
					<?php
									...
									<div class="AmazonWooCommerce-panel-content">
										<form class="AmazonWooCommerce-form" action="#save_with_ajax">
											...
											AmazonWooCommerceAjaxListTable::getInstance( $this->the_plugin )
												->setup(array(
													'id' 				=> 'AmazonWooCommerceAssetDownload',
													'show_header' 		=> true,
													'search_box' 		=> false,
													'items_per_page' 	=> 5,
													'post_statuses' 	=> array(
	                        	...
	                        	<div class="AmazonWooCommerce-panel">
									...
									<div class="AmazonWooCommerce-panel-content">
										<div class="AmazonWooCommerce-sync-details">
											...
											<div class="wp_syntax"><div class="code"><pre style="font-family:monospace;" class="bash"><span style="color: #c20cb9; font-weight: bold;">wget</span> <span style="color: #660033;">-q</span> <span style="color: #660033;">-O</span> - </span><?php echo admin_url('admin-ajax.php?action=AmazonWooAssetsCron');?> <span style="color: #000000; font-weight: bold;">&gt;/</span>dev<span style="color: #000000; font-weight: bold;">/</span>null <span style="color: #000000;">2</span><span style="color: #000000; font-weight: bold;">&gt;&amp;</span><span style="color: #000000;">1</span></pre></div></div>
...
if ( !function_exists('AmazonWooCommerceAssetDownload_cronjob') ) {
function AmazonWooCommerceAssetDownload_cronjob() {
	// Initialize the AmazonWooCommerceAssetDownload class
	$amzaffAssetDownload = new AmazonWooCommerceAssetDownload();
	$amzaffAssetDownload->cronjob();
}
}

// Initialize the AmazonWooCommerceAssetDownload class
$AmazonWooCommerceAssetDownload = AmazonWooCommerceAssetDownload::getInstance();