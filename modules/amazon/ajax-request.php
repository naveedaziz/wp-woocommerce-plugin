...
add_action('wp_ajax_AmazonWooCommerce_load_product', 'AmazonWooCommerce_load_product_callback');
...
add_action('wp_ajax_amazon_request', 'AmazonWooCommerceamazon_request_callback');
function AmazonWooCommerceamazon_request_callback() {
	...
	?>
			<div class="resultsTopBar">
				<h2>
					Showing <?php echo $requestData['page'];?> - <?php echo $response['Items']["TotalPages"];?> of <span id="AmazonWooCommerce-totalPages"><?php echo $response['Items']["TotalResults"];?></span> Results
				</h2>
		...
		?>
					<tr>
						...
						<td class="product-options">
							...
							?>
							<a class="AmazonWooCommerce-option-btn AmazonWooCommerce-load-product" href="#" rel="<?php echo $value['ASIN'];?>"><img src="<?php echo $plugin_uri;?>assets/update.png" /> Load this product </a>
						<td>
					</tr>
		<?php
				} // end foreach
