...
if (class_exists('aaTeamPluginDepedencies') != true) {
    class aaTeamPluginDepedencies
    {
	    ...
	    * Singleton pattern
	    *
	    * @return AmazonWooCommerceSpinner Singleton instance
	    */
		...
		public function depedencies_plugin_redirect_valid() {
			//delete_option('AmazonWooCommerce_depedencies_is_valid');
		...
		public function depedencies_plugin_redirect() {
			...
			delete_option('AmazonWooCommerce_depedencies_do_activation_redirect');
			wp_redirect( get_admin_url() . 'admin.php?page=AmazonWooCommerce' );
		}
		...
		public function verifyDepedencies() {
			...
			?>
			<div class="AmazonWooCommerce-message">
			...
			?>
			<input type="button" value="Re-Check Depedencies" class="AmazonWooCommerce-button blue AmazonWooCommerce-depedencies-check" style="margin-top: 10px;">
			<?php
